...
I chose the binwidth to be 25 because it looks easier to read.
...
ggplot(data = edibnb, mapping = aes(x = review_scores_rating, y = neighbourhood)
  ...
  geom_point()
```
There seems to be more higher ratings than lower ratings for these neighborhoods.
